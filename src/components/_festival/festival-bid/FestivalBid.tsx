  ...
  return (
      <div className="festival-bid" id="bid">
        <div className="container">
          ...
          <Form inputs={pageData.bidInputs} note={pageData.bidNote} nominations={pageData.nominations} typeForm="bid" disabled={pageData.bidDisabled} agreement={pageData.bidAgreement} />
        </div>
      </div>
  );
};
